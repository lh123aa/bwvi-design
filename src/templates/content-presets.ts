...
const BLUEPRINTS: Blueprint[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "pricing", variant: "", data: { name:"Pro",price:"$49/mo",features:["Unlimited projects","All integrations","Priority support","99.99% SLA"],cta:"Start Free Trial",featured:true } },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "timeline", variant: "", data: { items: [{icon:"🥗",title:"Appetizer",desc:"Seasonal starters"},{icon:"🍝",title:"Main Course",desc:"Chef's selection"},{icon:"🍰",title:"Dessert",desc:"Artisanal sweets"}] } },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "pricing", variant: "", data: { name:"Premium",price:"$79/mo",features:["Unlimited classes","Personal trainer","Nutrition plan","Free merch"],cta:"Start Free Trial",featured:true } },
  ...
  {id:"landing-photography",name:"摄影/视频 Photography",pageType:"landing",industry:["photography","摄影","photo","videography","film"],keywords:["photography","摄影","photo","portfolio","videographer"],direction:"photography",sections:[
    {type:"navbar",variant:"transparent",data:{logo:"{brand}",links:[{label:"Portfolio",href:"#"},{label:"Services",href:"#"},{label:"About",href:"#"},{label:"Contact",href:"#"}],cta:"Book"}},
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"View Portfolio"}},
    {type:"stats",variant:"compact",data:{items:[{num:"500+",label:"Sessions"},{num:"200+",label:"Clients"},{num:"4.9★",label:"Rating"},{num:"8",label:"Years"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"📸",title:"Portrait",desc:"Professional headshots."},{icon:"💍",title:"Wedding",desc:"Your special day."},{icon:"🏢",title:"Commercial",desc:"Brand content."}]}},
    {type:"cta",variant:"",data:{title:"Book a Session",subtitle:"Free consultation.",cta:"Get in Touch"}},{type:"footer",variant:"minimal",data:{description:"{brand}"}},
  ]},
  {id:"landing-music",name:"音乐人 Musician",pageType:"landing",industry:["music","音乐","musician","band","singer","artist"],keywords:["music","音乐","musician","band","singer","tour"],direction:"music-vibe",sections:[
    ...
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Stream Now"}},
    {type:"stats",variant:"compact",data:{items:[{num:"1M+",label:"Streams"},{num:"100+",label:"Shows"},{num:"50K+",label:"Followers"},{num:"3",label:"Albums"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"🎵",title:"Latest Album",desc:"Out now."},{icon:"🎫",title:"Tour Dates",desc:"Tickets on sale."},{icon:"👕",title:"Merch",desc:"Official store."}]}},
    {type:"cta",variant:"",data:{title:"Listen Now",subtitle:"Latest album out everywhere.",cta:"Stream"}},{type:"footer",variant:"minimal",data:{description:"{brand}"}},
  ]},
  {id:"landing-bar",name:"酒吧/夜店 Bar",pageType:"landing",industry:["bar","酒吧","nightclub","pub","cocktail","brewery"],keywords:["bar","酒吧","pub","cocktail","brewery","nightlife"],direction:"dark-luxury",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Menu",href:"#"},{label:"Events",href:"#"},{label:"Gallery",href:"#"},{label:"Contact",href:"#"}],cta:"Reserve"}},
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"View Menu"}},
    {type:"stats",variant:"compact",data:{items:[{num:"50+",label:"Cocktails"},{num:"4.8★",label:"Rating"},{num:"4.7★",label:"Atmosphere"},{num:"10+",label:"Events"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"🍸",title:"Signature Cocktails",desc:"Crafted perfection."},{icon:"🎵",title:"Live Music",desc:"Weekend shows."},{icon:"🌆",title:"Rooftop",desc:"Skyline views."}]}},
    {type:"cta",variant:"",data:{title:"Reserve a Table",subtitle:"VIP experience.",cta:"Book Now"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Visit",links:[{label:"Hours",href:"#"},{label:"Location",href:"#"},{label:"Parking",href:"#"},{label:"Contact",href:"#"}]},{title:"Events",links:[{label:"Calendar",href:"#"},{label:"Private Events",href:"#"},{label:"Live Music",href:"#"},{label:"Reservations",href:"#"}]}]}},
  ]},
  {id:"landing-bakery",name:"面包店/烘焙 Bakery",pageType:"landing",industry:["bakery","面包","烘焙","pastry","dessert","cake"],keywords:["bakery","面包","烘焙","pastry","dessert","cake","patisserie"],direction:"warm-editorial",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Menu",href:"#"},{label:"Order",href:"#"},{label:"Story",href:"#"},{label:"Contact",href:"#"}],cta:"Order"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"View Menu"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🥐",title:"Fresh Baked",desc:"Daily made."},{icon:"🎂",title:"Custom Cakes",desc:"Any occasion."},{icon:"☕",title:"Coffee",desc:"Premium brews."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"50+",label:"Items"},{num:"4.8★",label:"Rating"},{num:"15+",label:"Years"},{num:"1K+",label:"Daily"}]}},
    {type:"cta",variant:"",data:{title:"Order Online",subtitle:"Free delivery.",cta:"Order Now"}},{type:"footer",variant:"minimal",data:{description:"{brand}"}},
  ]},
  {id:"landing-veterinary",name:"宠物/兽医 Pet",pageType:"landing",industry:["pet","宠物","veterinary","vet","dog","cat","animal"],keywords:["pet","宠物","veterinary","vet","dog","cat","animal"],direction:"soft-minimal",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Services",href:"#"},{label:"Team",href:"#"},{label:"Resources",href:"#"},{label:"Contact",href:"#"}],cta:"Book"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Book Appointment"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🏥",title:"Checkups",desc:"Annual exams."},{icon:"💉",title:"Vaccinations",desc:"Complete care."},{icon:"🦷",title:"Dental",desc:"Oral hygiene."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"10K+",label:"Pets Treated"},{num:"4.9★",label:"Rating"},{num:"20+",label:"Years"},{num:"5",label:"Vets"}]}},
    {type:"cta",variant:"",data:{title:"Your Pet Deserves the Best",subtitle:"New patients welcome.",cta:"Book Now"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"Checkups",href:"#"},{label:"Vaccinations",href:"#"},{label:"Surgery",href:"#"},{label:"Dental",href:"#"}]},{title:"Clinic",links:[{label:"About",href:"#"},{label:"Team",href:"#"},{label:"Resources",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-consulting",name:"商业咨询 Consulting",pageType:"landing",industry:["consulting","咨询","consultant","business","strategy"],keywords:["consulting","咨询","business","strategy","management"],direction:"corporate-trust",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Services",href:"#"},{label:"Case Studies",href:"#"},{label:"Team",href:"#"},{label:"Contact",href:"#"}],cta:"Free Consult"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Schedule a Call"}},
    {type:"features",variant:"grid",data:{items:[{icon:"📊",title:"Strategy",desc:"Market analysis."},{icon:"📈",title:"Growth",desc:"Scale your business."},{icon:"🤝",title:"Advisory",desc:"Expert guidance."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"200+",label:"Clients"},{num:"98%",label:"Satisfaction"},{num:"15+",label:"Years"},{num:"$2B+",label:"Value Created"}]}},
    {type:"testimonials",variant:"grid",data:{items:[{quote:"Transformed our business.",author:"CEO, Tech Corp"},{quote:"Invaluable strategic advice.",author:"Founder, Startup"},{quote:"Highly recommended.",author:"Director, Enterprise"}]}},
    {type:"cta",variant:"",data:{title:"Let's Talk",subtitle:"Free initial consultation.",cta:"Schedule Now"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"Strategy",href:"#"},{label:"Growth",href:"#"},{label:"Operations",href:"#"},{label:"Technology",href:"#"}]},{title:"Company",links:[{label:"About",href:"#"},{label:"Team",href:"#"},{label:"Careers",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-medical",name:"医疗诊所 Medical",pageType:"landing",industry:["medical","医疗","clinic","doctor","healthcare","hospital"],keywords:["medical","医疗","clinic","doctor","healthcare","hospital"],direction:"healthcare-clean",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Services",href:"#"},{label:"Doctors",href:"#"},{label:"Patient Info",href:"#"},{label:"Contact",href:"#"}],cta:"Book"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Book Appointment"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🩺",title:"General",desc:"Primary care."},{icon:"❤️",title:"Specialty",desc:"Expert care."},{icon:"🏥",title:"Diagnostics",desc:"On-site lab."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"50K+",label:"Patients"},{num:"98%",label:"Satisfaction"},{num:"30+",label:"Doctors"},{num:"24/7",label:"Support"}]}},
    {type:"cta",variant:"",data:{title:"Your Health Matters",subtitle:"Same-day appointments.",cta:"Book Now"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"Primary Care",href:"#"},{label:"Specialty",href:"#"},{label:"Lab",href:"#"},{label:"Telehealth",href:"#"}]},{title:"Patients",links:[{label:"Portal",href:"#"},{label:"Insurance",href:"#"},{label:"Forms",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-legal",name:"法律律所 Legal",pageType:"landing",industry:["legal","法律","law","lawyer","attorney","firm"],keywords:["legal","法律","law","lawyer","attorney","firm"],direction:"legal-format",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Practice Areas",href:"#"},{label:"Team",href:"#"},{label:"Resources",href:"#"},{label:"Contact",href:"#"}],cta:"Free Consult"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Schedule Consultation"}},
    {type:"features",variant:"grid",data:{items:[{icon:"⚖️",title:"Corporate",desc:"Business law."},{icon:"🏠",title:"Real Estate",desc:"Property law."},{icon:"👨‍👩‍👧",title:"Family",desc:"Family law."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"5K+",label:"Cases"},{num:"95%",label:"Success Rate"},{num:"30+",label:"Attorneys"},{num:"40+",label:"Years"}]}},
    {type:"cta",variant:"",data:{title:"Protect Your Rights",subtitle:"Free initial consultation.",cta:"Contact Us"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Practice Areas",links:[{label:"Corporate",href:"#"},{label:"Real Estate",href:"#"},{label:"Family",href:"#"},{label:"Criminal",href:"#"}]},{title:"Firm",links:[{label:"About",href:"#"},{label:"Team",href:"#"},{label:"Results",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-nonprofit",name:"非营利 Nonprofit",pageType:"landing",industry:["nonprofit","非营利","charity","ngo","foundation","公益"],keywords:["nonprofit","charity","ngo","foundation","公益","donate"],direction:"nonprofit-soft",sections:[
    {type:"navbar",variant:"centered",data:{logo:"{brand}",links:[{label:"Mission",href:"#"},{label:"Impact",href:"#"},{label:"Get Involved",href:"#"},{label:"Donate",href:"#"}],cta:"Donate"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Make a Donation"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🌍",title:"Our Mission",desc:"Making a difference."},{icon:"📊",title:"Impact",desc:"Measurable results."},{icon:"🤲",title:"Volunteer",desc:"Get involved."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"100K+",label:"Lives Impacted"},{num:"50+",label:"Programs"},{num:"1K+",label:"Volunteers"},{num:"20+",label:"Years"}]}},
    {type:"cta",variant:"",data:{title:"Make a Difference",subtitle:"Every donation counts.",cta:"Donate Now"}},{type:"footer",variant:"minimal",data:{description:"{brand}"}},
  ]},
  {id:"landing-event",name:"活动/会议 Event",pageType:"landing",industry:["event","活动","conference","meetup","workshop","seminar"],keywords:["event","活动","conference","meetup","workshop","seminar","convention"],direction:"bold-contrast",sections:[
    {type:"navbar",variant:"transparent",data:{logo:"{brand}",links:[{label:"Schedule",href:"#"},{label:"Speakers",href:"#"},{label:"Tickets",href:"#"},{label:"Venue",href:"#"}],cta:"Register"}},
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Get Tickets"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🎤",title:"Speakers",desc:"Industry leaders."},{icon:"📋",title:"Workshops",desc:"Hands-on."},{icon:"🤝",title:"Networking",desc:"Connect."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"50+",label:"Speakers"},{num:"2K+",label:"Attendees"},{num:"30+",label:"Sessions"},{num:"4.8★",label:"Rating"}]}},
    {type:"pricing",variant:"",data:{name:"Early Bird",price:"$299",features:["Full Access","Workshops","Lunch","Networking"],cta:"Register Now",featured:false}},
    {type:"cta",variant:"",data:{title:"Don't Miss Out",subtitle:"Early bird ends soon.",cta:"Register Today"}},{type:"footer",variant:"minimal",data:{description:"{brand}"}},
  ]},
  {id:"landing-wedding",name:"婚礼策划 Wedding",pageType:"landing",industry:["wedding","婚礼","bridal","marriage","wedding planner"],keywords:["wedding","婚礼","bridal","婚纱","wedding planner","venue"],direction:"wedding-elegant",sections:[
    {type:"navbar",variant:"transparent",data:{logo:"{brand}",links:[{label:"Services",href:"#"},{label:"Gallery",href:"#"},{label:"Packages",href:"#"},{label:"Contact",href:"#"}],cta:"Inquire"}},
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Plan Your Day"}},
    {type:"stats",variant:"compact",data:{items:[{num:"500+",label:"Weddings"},{num:"4.9★",label:"Rating"},{num:"10+",label:"Awards"},{num:"15",label:"Years"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"💍",title:"Planning",desc:"Full-service."},{icon:"📸",title:"Photography",desc:"Capture moments."},{icon:"🎵",title:"Music",desc:"Live band/DJ."}]}},
    {type:"cta",variant:"",data:{title:"Your Dream Wedding",subtitle:"Free consultation.",cta:"Get Started"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"Planning",href:"#"},{label:"Photography",href:"#"},{label:"Music",href:"#"},{label:"Catering",href:"#"}]},{title:"Company",links:[{label:"About",href:"#"},{label:"Gallery",href:"#"},{label:"Testimonials",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-creative-agency",name:"创意代理 Agency",pageType:"landing",industry:["agency","代理","creative","advertising","marketing","branding"],keywords:["agency","代理","creative","advertising","marketing","branding"],direction:"agency-dark",sections:[
    {type:"navbar",variant:"transparent",data:{logo:"{brand}",links:[{label:"Work",href:"#"},{label:"Services",href:"#"},{label:"About",href:"#"},{label:"Contact",href:"#"}],cta:"Let's Talk"}},
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"View Our Work"}},
    {type:"stats",variant:"compact",data:{items:[{num:"500+",label:"Projects"},{num:"200+",label:"Clients"},{num:"50+",label:"Awards"},{num:"4.8★",label:"Rating"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"🎨",title:"Branding",desc:"Identity design."},{icon:"🌐",title:"Web",desc:"Digital experiences."},{icon:"📱",title:"Social",desc:"Social media."}]}},
    {type:"testimonials",variant:"grid",data:{items:[{quote:"Best agency we've worked with.",author:"CMO, Fortune 500"},{quote:"Transformed our brand.",author:"CEO, Startup"}]}},
    {type:"cta",variant:"",data:{title:"Let's Create Together",subtitle:"Free discovery call.",cta:"Get in Touch"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"Branding",href:"#"},{label:"Web Design",href:"#"},{label:"Development",href:"#"},{label:"Marketing",href:"#"}]},{title:"Company",links:[{label:"Work",href:"#"},{label:"About",href:"#"},{label:"Careers",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-realestate-dev",name:"房地产开发 Developer",pageType:"landing",industry:["real estate development","房地产","developer","property","construction developer"],keywords:["real estate","developer","房地产","property","construction","development"],direction:"corporate-trust",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Projects",href:"#"},{label:"Gallery",href:"#"},{label:"Team",href:"#"},{label:"Contact",href:"#"}],cta:"Inquire"}},
    {type:"hero",variant:"split",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"View Projects"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🏢",title:"Residential",desc:"Luxury homes."},{icon:"🏬",title:"Commercial",desc:"Office spaces."},{icon:"🌳",title:"Communities",desc:"Master-planned."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"100+",label:"Projects"},{num:"5K+",label:"Homes Built"},{num:"4.8★",label:"Rating"},{num:"30+",label:"Years"}]}},
    {type:"cta",variant:"",data:{title:"Find Your Dream Home",subtitle:"Schedule a tour.",cta:"Explore"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Projects",links:[{label:"Residential",href:"#"},{label:"Commercial",href:"#"},{label:"Communities",href:"#"},{label:"Gallery",href:"#"}]},{title:"Company",links:[{label:"About",href:"#"},{label:"Team",href:"#"},{label:"Careers",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"dashboard-analytics",name:"数据分析 Dashboard",pageType:"dashboard",industry:["analytics","分析","dashboard","data","metrics"],keywords:["dashboard","analytics","metrics","data","kpi","report"],direction:"tech-utility",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Dashboard",href:"#"},{label:"Reports",href:"#"},{label:"Settings",href:"#"}],cta:""}},
    {type:"stats_counter",variant:"grid",data:{items:[{num:"2.4M",label:"Users",change:"+12%"},{num:"$48K",label:"Revenue",change:"+8%"},{num:"92%",label:"Retention",change:"+3%"},{num:"1.2s",label:"Load Time",change:"-15%"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"📈",title:"Revenue",desc:"Real-time tracking."},{icon:"👥",title:"Users",desc:"Cohort analysis."},{icon:"⚡",title:"Performance",desc:"Speed metrics."}]}},
    {type:"cta",variant:"",data:{title:"View Full Report",subtitle:"Detailed analytics.",cta:"Open Dashboard"}},
  ]},
  {id:"dashboard-ecommerce",name:"电商管理 Dashboard",pageType:"dashboard",industry:["ecommerce","电商","shop","store","retail","merchant"],keywords:["ecommerce","电商","shop","dashboard","orders","inventory"],direction:"corporate-trust",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Orders",href:"#"},{label:"Products",href:"#"},{label:"Customers",href:"#"},{label:"Analytics",href:"#"}],cta:""}},
    {type:"stats_counter",variant:"grid",data:{items:[{num:"156",label:"Orders Today",change:"+23%"},{num:"$12.4K",label:"Revenue",change:"+18%"},{num:"89",label:"Active Carts",change:"-5%"},{num:"4.7★",label:"Rating",change:"+0.2"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"📦",title:"Orders",desc:"Manage & fulfill."},{icon:"🏷️",title:"Products",desc:"Inventory control."},{icon:"👤",title:"Customers",desc:"CRM insights."}]}},
    {type:"cta",variant:"",data:{title:"Go to Dashboard",subtitle:"Manage your store.",cta:"Open"}},
  ]},
  {id:"app-photography",name:"摄影 App Photography",pageType:"app",industry:["photography","摄影","camera","photo app","edit"],keywords:["photography app","camera","photo","edit","filter","gallery"],direction:"photography",sections:[
    {type:"navbar",variant:"transparent",data:{logo:"{brand}",links:[{label:"Feed",href:"#"},{label:"Edit",href:"#"},{label:"Profile",href:"#"}],cta:""}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Get Started"}},
    {type:"features",variant:"grid",data:{items:[{icon:"✨",title:"Filters",desc:"Pro presets."},{icon:"✂️",title:"Edit",desc:"Advanced tools."},{icon:"📤",title:"Share",desc:"Export & post."}]}},
    {type:"cta",variant:"",data:{title:"Start Creating",subtitle:"Free to download.",cta:"Download"}},{type:"footer",variant:"minimal",data:{description:"{brand}"}},
  ]},
  {id:"app-fitness-tracker",name:"健身 App Fitness",pageType:"app",industry:["fitness","健身","workout","exercise","health app"],keywords:["fitness app","workout","exercise","health","tracker","steps"],direction:"corporate-trust",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Dashboard",href:"#"},{label:"Workouts",href:"#"},{label:"Progress",href:"#"},{label:"Profile",href:"#"}],cta:""}},
    {type:"stats_counter",variant:"grid",data:{items:[{num:"8,432",label:"Steps",change:"+12%"},{num:"487",label:"Calories",change:"+8%"},{num:"45min",label:"Active",change:"+5%"},{num:"12",label:"Streak Days",change:"+1"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"🏃",title:"Workouts",desc:"Guided sessions."},{icon:"📊",title:"Progress",desc:"Track gains."},{icon:"🥗",title:"Nutrition",desc:"Meal tracking."}]}},
    {type:"cta",variant:"",data:{title:"Start Your Journey",subtitle:"Free 7-day trial.",cta:"Begin"}},
  ]},
  {id:"app-food-delivery",name:"外卖 App Food Delivery",pageType:"app",industry:["food delivery","外卖","delivery","food app","restaurant delivery"],keywords:["food delivery","外卖","delivery","restaurant","order","takeout"],direction:"playful-color",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Search",href:"#"},{label:"Orders",href:"#"},{label:"Cart",href:"#"},{label:"Profile",href:"#"}],cta:""}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Order Now"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🍔",title:"Restaurants",desc:"Local favorites."},{icon:"🚚",title:"Delivery",desc:"30 min or free."},{icon:"⭐",title:"Reviews",desc:"Real ratings."}]}},
    {type:"cta",variant:"",data:{title:"Hungry?",subtitle:"First order free delivery.",cta:"Get the App"}},
  ]},
  {id:"deck-pitch",name:"融资路演 Deck",pageType:"deck",industry:["pitch","融资","investor","fundraising","startup","vc"],keywords:["pitch","deck","融资","investor","fundraising","startup","vc","路演"],direction:"dark-luxury",sections:[
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Invest"}},
    {type:"stats",variant:"list",data:{items:[{num:"$2M",label:"Revenue"},{num:"150%",label:"Growth"},{num:"50K",label:"Users"},{num:"4.9★",label:"NPS"}]}},
    {type:"features",variant:"grid",data:{items:[{icon:"📈",title:"Traction",desc:"Strong metrics."},{icon:"👥",title:"Team",desc:"Expert founders."},{icon:"🌎",title:"Market",desc:"$10B TAM."}]}},
    {type:"cta",variant:"",data:{title:"Join Us",subtitle:"Series A raising.",cta:"Invest Now"}},
  ]},
  {id:"poster-event",name:"活动海报 Event Poster",pageType:"poster",industry:["poster","海报","event","promotion","advertising"],keywords:["poster","海报","event","promo","ad","宣传"],direction:"bold-contrast",sections:[
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Get Tickets"}},
    {type:"stats",variant:"compact",data:{items:[{num:"Date",label:"May 15"},{num:"Venue",label:"City Hall"},{num:"Time",label:"7:00 PM"}]}},
    {type:"cta",variant:"",data:{title:"Limited Seats",subtitle:"Early bird available.",cta:"Buy Now"}},
  ]},
  {id:"poster-product",name:"产品海报 Product Poster",pageType:"poster",industry:["product","产品","launch","promotion","sale"],keywords:["product","产品","poster","launch","sale","promotion"],direction:"dark-luxury",sections:[
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Shop Now"}},
    {type:"features",variant:"list",data:{items:[{icon:"⭐",title:"Featured",desc:"Best seller."},{icon:"🏆",title:"Award",desc:"Product of the year."},{icon:"💯",title:"Guarantee",desc:"Satisfaction."}]}},
    {type:"cta",variant:"",data:{title:"Limited Offer",subtitle:"Free shipping.",cta:"Order Now"}},
  ]},
  {id:"landing-travel",name:"旅行/旅游 Travel",pageType:"landing",industry:["travel","旅游","tour","vacation","trip","holiday"],keywords:["travel","旅游","tour","vacation","trip","holiday","destination"],direction:"sunset-warm",sections:[
    {type:"navbar",variant:"transparent",data:{logo:"{brand}",links:[{label:"Destinations",href:"#"},{label:"Tours",href:"#"},{label:"About",href:"#"},{label:"Contact",href:"#"}],cta:"Book"}},
    {type:"hero",variant:"fullscreen",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Explore Destinations"}},
    {type:"features",variant:"grid",data:{items:[{icon:"✈️",title:"Flights",desc:"Best deals."},{icon:"🏨",title:"Hotels",desc:"Curated stays."},{icon:"🗺️",title:"Tours",desc:"Guided experiences."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"100+",label:"Destinations"},{num:"50K+",label:"Travelers"},{num:"4.8★",label:"Rating"},{num:"15",label:"Years"}]}},
    {type:"cta",variant:"",data:{title:"Your Next Adventure",subtitle:"Book with confidence.",cta:"Start Planning"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Destinations",links:[{label:"Europe",href:"#"},{label:"Asia",href:"#"},{label:"Americas",href:"#"},{label:"Africa",href:"#"}]},{title:"Company",links:[{label:"About",href:"#"},{label:"Careers",href:"#"},{label:"Travel Blog",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-coach",name:"个人教练 Coach",pageType:"landing",industry:["coach","教练","mentor","life coach","consulting"],keywords:["coach","教练","mentoring","life coach","career","personal"],direction:"soft-minimal",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Services",href:"#"},{label:"About",href:"#"},{label:"Testimonials",href:"#"},{label:"Contact",href:"#"}],cta:"Book"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Free Discovery Call"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🎯",title:"1:1 Coaching",desc:"Personalized."},{icon:"📋",title:"Career Planning",desc:"Roadmap."},{icon:"💡",title:"Strategy",desc:"Action plan."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"500+",label:"Clients"},{num:"97%",label:"Success Rate"},{num:"4.9★",label:"Rating"},{num:"10+",label:"Years"}]}},
    {type:"testimonials",variant:"compact",data:{items:[{quote:"Life-changing experience.",author:"Client"}]}},
    {type:"cta",variant:"",data:{title:"Transform Your Life",subtitle:"Free 30-min consultation.",cta:"Book Now"}},{type:"footer",variant:"minimal",data:{description:"{brand}"}},
  ]},
  {id:"landing-dentist",name:"牙科诊所 Dentist",pageType:"landing",industry:["dentist","牙科","dental","teeth","orthodontist"],keywords:["dentist","牙科","dental","teeth","orthodontist","dental clinic"],direction:"healthcare-clean",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Services",href:"#"},{label:"Team",href:"#"},{label:"Patient Info",href:"#"},{label:"Contact",href:"#"}],cta:"Book"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Book Appointment"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🦷",title:"General",desc:"Cleanings & exams."},{icon:"✨",title:"Cosmetic",desc:"Whitening & veneers."},{icon:"🦷",title:"Ortho",desc:"Braces & Invisalign."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"10K+",label:"Patients"},{num:"4.9★",label:"Rating"},{num:"20+",label:"Years"},{num:"5",label:"Doctors"}]}},
    {type:"cta",variant:"",data:{title:"Your Smile, Our Priority",subtitle:"New patients welcome.",cta:"Book Now"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"General",href:"#"},{label:"Cosmetic",href:"#"},{label:"Orthodontics",href:"#"},{label:"Emergency",href:"#"}]},{title:"Clinic",links:[{label:"About",href:"#"},{label:"Team",href:"#"},{label:"Insurance",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-mechanic",name:"汽修/保养 Mechanic",pageType:"landing",industry:["mechanic","汽修","auto repair","car service","garage","maintenance"],keywords:["mechanic","汽修","auto repair","car service","garage","tires"],direction:"tech-utility",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Services",href:"#"},{label:"Pricing",href:"#"},{label:"Gallery",href:"#"},{label:"Contact",href:"#"}],cta:"Book"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Schedule Service"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🔧",title:"Repairs",desc:"All makes & models."},{icon:"🛞",title:"Tires",desc:"Installation & rotation."},{icon:"🔍",title:"Diagnostics",desc:"Computerized."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"10K+",label:"Cars Serviced"},{num:"4.7★",label:"Rating"},{num:"25+",label:"Years"},{num:"12",label:"Techs"}]}},
    {type:"cta",variant:"",data:{title:"Keep Your Car Running",subtitle:"Free estimate.",cta:"Book Now"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"Repairs",href:"#"},{label:"Tires",href:"#"},{label:"Oil Change",href:"#"},{label:"Diagnostics",href:"#"}]},{title:"Shop",links:[{label:"About",href:"#"},{label:"Gallery",href:"#"},{label:"Reviews",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-interior",name:"室内设计 Interior Design",pageType:"landing",industry:["interior","室内设计","design","home decor","renovation"],keywords:["interior","室内设计","home decor","renovation","furniture","staging"],direction:"cold-minimal",sections:[
    {type:"navbar",variant:"transparent",data:{logo:"{brand}",links:[{label:"Portfolio",href:"#"},{label:"Services",href:"#"},{label:"Process",href:"#"},{label:"Contact",href:"#"}],cta:"Consult"}},
    {type:"hero",variant:"split",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"View Portfolio"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🛋️",title:"Residential",desc:"Beautiful homes."},{icon:"🏢",title:"Commercial",desc:"Workspaces."},{icon:"✨",title:"Staging",desc:"Sell faster."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"300+",label:"Projects"},{num:"4.9★",label:"Rating"},{num:"50+",label:"Awards"},{num:"20",label:"Years"}]}},
    {type:"cta",variant:"",data:{title:"Transform Your Space",subtitle:"Free consultation.",cta:"Get Started"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"Residential",href:"#"},{label:"Commercial",href:"#"},{label:"Staging",href:"#"},{label:"Consulting",href:"#"}]},{title:"Studio",links:[{label:"Portfolio",href:"#"},{label:"About",href:"#"},{label:"Process",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-salon",name:"美发/美容 Salon",pageType:"landing",industry:["salon","美发","hair","beauty","barber","hair salon"],keywords:["salon","美发","hair","barber","beauty","hairstylist"],direction:"garden-bloom",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Services",href:"#"},{label:"Gallery",href:"#"},{label:"Book",href:"#"},{label:"Contact",href:"#"}],cta:"Book"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Book Appointment"}},
    {type:"features",variant:"grid",data:{items:[{icon:"💇",title:"Haircuts",desc:"Precision cuts."},{icon:"🎨",title:"Color",desc:"Highlights & balayage."},{icon:"💆",title:"Treatments",desc:"Deep conditioning."}]}},
    {type:"stats",variant:"compact",data:{items:[{num:"50K+",label:"Cuts"},{num:"4.8★",label:"Rating"},{num:"15+",label:"Years"},{num:"10",label:"Stylists"}]}},
    {type:"cta",variant:"",data:{title:"Look Your Best",subtitle:"New clients 20% off.",cta:"Book Now"}},{type:"footer",variant:"default",data:{description:"{brand}",columns:[{title:"Services",links:[{label:"Haircuts",href:"#"},{label:"Color",href:"#"},{label:"Treatments",href:"#"},{label:"Nails",href:"#"}]},{title:"Salon",links:[{label:"About",href:"#"},{label:"Gallery",href:"#"},{label:"Stylists",href:"#"},{label:"Contact",href:"#"}]}]}},
  ]},
  {id:"landing-cannabis",name:"大麻/医用 Cannabis",pageType:"landing",industry:["cannabis","cbd","dispensary","weed","marijuana","wellness"],keywords:["cannabis","cbd","dispensary","wellness","hemp","tincture"],direction:"nature-organic",sections:[
    {type:"navbar",variant:"default",data:{logo:"{brand}",links:[{label:"Shop",href:"#"},{label:"Learn",href:"#"},{label:"About",href:"#"},{label:"Contact",href:"#"}],cta:"Shop"}},
    {type:"hero",variant:"centered",data:{title:"{brand}",subtitle:"{tagline} — {description}",cta:"Browse Products"}},
    {type:"features",variant:"grid",data:{items:[{icon:"🌿",title:"Flower",desc:"Premium strains."},{icon:"💧",title:"Tinctures",desc:"Sublingual oils."},{icon:"🍬",title:"Edibles",desc:"Delicious options."}]}},
